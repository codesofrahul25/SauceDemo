...
public class CartPageSteps {
	...
	public void the_products_should_get_added_in_the_cart() throws IOException {
		cart = new CartPage(testcontext.ts.initializeWebDriver());
	...
	public void user_navigates_to_checkout_page() throws IOException {
		cart = new CartPage(testcontext.ts.initializeWebDriver());
		cart.clickChkOut();
	}
