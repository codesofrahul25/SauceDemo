...
public class LoginPageSteps {
	...
	{
		lp = testcontext.pm.getLoginPageObject();
	...
	public void errorMsg()
	{
		...
		Assert.assertEquals(errmsg, "Epic sadface: Username and password do not match any user in this service", "expected message is not displayed");
	}
